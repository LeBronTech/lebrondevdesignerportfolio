    ...
    <section id="about" className="bg-about-bg relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 pb-20 pt-32">
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          <div className="lg:col-span-2" data-aos="fade-up" data-aos-offset="150">
            <img 
          ...
          <div className="lg:col-span-3 text-center lg:text-left" data-aos="fade-up" data-aos-delay="200" data-aos-offset="150">
            ...
            <ul className="text-foreground/80 list-none space-y-3 mb-6 text-left inline-block mx-auto lg:mx-0">
            ...
            <div className="mt-8">
              <h3 className="font-primary uppercase tracking-widest text-sm gradient-title-animation mb-4 lg:text-left">
                Siga-me
              </h3>
